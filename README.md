# tax-doc-sdk-tax1098t

Software development kit to generate IRS Form 1098-T as PDF file using Financial Data Exchange (FDX) standards including QR codes and embedded JSON.

<img alt="Sample Form" src="samples/Tax1098T.sample.png" width="850"/>
