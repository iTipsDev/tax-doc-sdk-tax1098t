...
import irs.fdxtax640.jsonserializers.Tax1098TSerializer;
import irs.fdxtax640.jsonserializers.TaxStatementListSerializer;
import irs.fdxtax640.map2objects.Map2Tax1098T;
import irs.fdxtax640.obj2mappers.TaxStatementList2Map;

import org.apache.commons.lang3.time.StopWatch;
import org.taxdataexchange.core.pdfbuilders.Tax1098TPdfBuilder;
...
public class Tax1098TDocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax1098T obj = Map2Tax1098T.generate( row );
        {
            String asJson = Tax1098TSerializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax1098T.csv";
        ...
        String outputFileName = "Tax1098T.rows.json";
    ...
    public static void main(String[] args) {
        ...
        Tax1098TDocumentGenerator generator = new Tax1098TDocumentGenerator( );
