package org.taxdataexchange.usage.tax1098t;

import org.taxdataexchange.core.utils.*;
import org.taxdataexchange.docs.tax1098t.models.*;
import org.taxdataexchange.docs.tax1098t.utils.*;

public class Tax1098TDocumentGenerator {
    ...
    public static TaxDataList sampleData( ) {
        ...
        // Sample data
        // -----------------------------------------------------------------
        TaxData taxData = SampleData.sampleTaxData( "Tax1098T" );
    ...
    public static byte[] sampleQrAsPng( ) {
        ...
        Tax1098TPdfBuilder pdfBuilder = new Tax1098TPdfBuilder( );
        byte[] bytes = pdfBuilder.buildQr( taxDataList );

        String filePath = "samples/Tax1098T.qr.png";
    ...
    public static void samplePdf( ) {
        ...
        String filePath = "samples/Tax1098T.sample.pdf";
        FileUtils.bytesToFile( pdfBytes, filePath );
        System.out.println( filePath );

        String filePathPng = "samples/Tax1098T.sample.png";
    ...
    public static void addCoverPage() {
        ...
        String filePath2 = "samples/Tax1098T.cover.pdf";
        FileUtils.bytesToFile( combinedBytes, filePath2 );
    ...
    public static void insertQrCode() {
        ...
        String filePath2 = "samples/Tax1098T.inserted.pdf";
        FileUtils.bytesToFile( combinedBytes, filePath2 );
    ...
    public static void main(String[] args) {
        ...
        System.out.println( "Tax1098TDocumentGenerator Begin" );
        ...
        System.out.println( "Tax1098TDocumentGenerator Done" );
